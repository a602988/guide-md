...
## [預約系統設定](/guide/default#預約系統設定){#預約系統設定}
...
**[活動促銷](/guide/reservation#活動促銷)：建立套票、試營運限定優惠價、大量團體票優惠等等**
    ...
    * [匯入折價卷序號](/guide/reservation#匯入折價卷序號)
...
## [已預約管理](/guide/default#已預約管理){#已預約管理}
...
* [產品分類](/guide/product-category) ： `商品管理->商品分類`：因目前無實際商品販售，皆為訂購，請先建立 票卷、課程、活動 此三項分類即可。
